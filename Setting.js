...
global.sudo  =  process.env.SUDO || "221764298614" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '03_04_2024_SIGMA_MD_v9Ug9nPt_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
